...
class Vesc(object):
    ...
    def refresh_data(self):
        ...
        if response is not None:
            ...
            self._ebike_app_data.motor_current_x100 = struct.unpack_from('>l', response, 7)[0] / 100.0
            self._ebike_app_data.battery_current_x100 = struct.unpack_from('>l', response, 11)[0] / 100.0
            self._ebike_app_data.motor_speed_erpm = struct.unpack_from('>l', response, 25)[0]
            self._ebike_app_data.battery_voltage_x10 = struct.unpack_from('>h', response, 29)[0] / 10.0
